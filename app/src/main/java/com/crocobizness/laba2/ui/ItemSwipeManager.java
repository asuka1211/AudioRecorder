...
public class ItemSwipeManager implements RecyclerView.OnItemTouchListener, RecyclerView.OnChildAttachStateChangeListener {
    ...
    public ItemSwipeManager(@NonNull Context context, @NonNull SwipeListener listener) {
